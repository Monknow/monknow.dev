...
import {ContactameContent} from "@interfaces/ContactameTypes";
...
export const Contactame = () => {
	...
	const recordContenido: Record<"es" | "en", ContactameContent> = {
		es: {
	...
	return (
		<ContactameEstilizado id="contact-me">
			...
			<ContactameFormulario
				action="https://formsubmit.io/send/8b76bd5b-4abf-4a18-b52c-df8caeda0157"
				method="POST">
