import {CartasConocimientosProps} from "@interfaces/CartaConocimientosTypes";
...
export const CartaConocimientos: FC<CartasConocimientosProps> = ({Svg, titulo, descripcion, lista}) => {
	return (
