...
import {FooterContent, FooterProps} from "@interfaces/FooterTypes";
...
export const FooterPagina: FC<FooterProps> = ({atribucion, atribucionURL}) => {
	const {locale} = useLocalization();
	const localeFijado = locale === "en" ? "en" : "es";

	const recordContenido: Record<"es" | "en", FooterContent> = {
		es: {
