...
const FooterPagina = ({atribucion, atribucionURL}) => {
	...
	return (
		<FooterEstilizado>
			...
			<FooterRedesSociales>
				<FooterRedesSocialesItem href="https://twitter.com/CodeMonknow" target="_blank" rel="noreferrer">
				...
				<FooterRedesSocialesItem href="https://www.linkedin.com/in/monknow" target="_blank" rel="noreferrer">
					<FooterRedesSocialesItemLi>
						<svg xmlns="http://www.w3.org/2000/svg" fill="#FFf" width="24" height="24" viewBox="0 0 24 24">
				...
				<FooterRedesSocialesItem href="https://www.instagram.com/monknow_dev/" target="_blank" rel="noreferrer">
					<FooterRedesSocialesItemLi>
						<svg xmlns="http://www.w3.org/2000/svg" fill="#FFf" width="24" height="24" viewBox="0 0 24 24">
