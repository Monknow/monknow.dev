...
import {PortfolioPageProps, PortfolioPageContent} from "@interfaces/PortfolioPageTypes";
...
const PortfolioPage: FC<PortfolioPageProps> = ({data}) => {
	...
	const recordContenido: Record<"es" | "en", PortfolioPageContent> = {
		es: {
			titulo: "Portafolio",
	...
	const {titulo, descripcion} = recordContenido[localeFijado];
