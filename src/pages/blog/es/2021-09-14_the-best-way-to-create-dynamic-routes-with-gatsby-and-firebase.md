...
cuerpo: >-
  ...
  ![Sitio Web creado con Gatsby](/assets/gatsby-site.png "Gatsby Home")
  ...
  ![Añadir proyecto en Firebase Console](/assets/firebase-add-project.png "Añadir Proyecto")
  ...
  ![Añadir App en Firebase](/assets/firebase-add-app.png "Añadir App")
  ...
  ![Añadir Firestore en Firebase](/assets/firebase-create-database.png "Añadir Firestore")
  ...
  ![Añadir datos de muestra a Firestore](/assets/firebase-create-data.png "Añadir Datos")
  ...
  ![Localhost mostrando "Amazing!"](/assets/client-only-route.png "Rutas solamente del cliente")
  ...
  ![Localhost mostrando "Hola John Doe"](/assets/final-result.png "Resultado Final")
